...
You can act by pressing the controller. Here are the options: up, right, down, left, attack, jump
...
```
[{{"thought":"...","actions":["up"], "duration":1.0}}, {{"actions":["attack"], "duration":2.0}}]
```
...
def get_system_prompt():
    ...
    """
    game = "Super Mario 64"
    goal = "to collect Power Stars scattered across various levels in the game, which are accessed through paintings in Princess Peach's castle. The player, as Mario, aims to collect these stars to progress through the castle, unlock new areas, and ultimately defeat Bowser in three different battles to rescue Princess Peach. For now don't worry on reading signs or talking to characters, try to make decisions based on your memory of the game."
